...
public class InfernoChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation field_147505_d = new ResourceLocation(Main.MODID + ":textures/blocks/InfernoChestLarge.png");
    private static final ResourceLocation field_147504_g = new ResourceLocation(Main.MODID + ":textures/blocks/InfernoChest.png");
    private ModelChest field_147510_h = new ModelChest();
    private ModelChest field_147511_i = new ModelLargeChest();
    private boolean field_147509_j;
    private static final String __OBFID = "CL_00000965";

    public InfernoChestRenderer()
    {
    ...
    public void renderTileEntityAt(TileEntityInfernoChest p_147502_1_, double p_147502_2_, double p_147502_4_, double p_147502_6_, float p_147502_8_)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof InfernoChest && i == 0)
            {
                try
                {
                ((InfernoChest)block).func_149954_e(p_147502_1_.getWorldObj(), p_147502_1_.xCoord, p_147502_1_.yCoord, p_147502_1_.zCoord);
                }
    ...
    {
        this.renderTileEntityAt((TileEntityInfernoChest)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}