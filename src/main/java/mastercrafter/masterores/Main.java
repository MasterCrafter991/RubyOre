package mastercrafter.masterores;

import mastercrafter.masterores.armor.DragoniumArmor;
import mastercrafter.masterores.blocks.CompressedCobblestone;
import mastercrafter.masterores.blocks.CompressedStone;
import mastercrafter.masterores.blocks.CompressedStoneBrick;
import mastercrafter.masterores.blocks.CompressedStoneGen;
import mastercrafter.masterores.blocks.CorruptDiamondBlock;
import mastercrafter.masterores.blocks.CorruptDiamondOre;
import mastercrafter.masterores.blocks.DragoniumOre;
import mastercrafter.masterores.blocks.DragoniumOreGen;
import mastercrafter.masterores.blocks.PureDiamondBlock;
import mastercrafter.masterores.blocks.RubyOre;
import mastercrafter.masterores.blocks.RubyOreGen;
import mastercrafter.masterores.items.AdvancedWMC;
import mastercrafter.masterores.items.ApplePie;
import mastercrafter.masterores.items.BasicWMC;
import mastercrafter.masterores.items.CorruptDiamond;
import mastercrafter.masterores.items.DragoniumAxe;
import mastercrafter.masterores.items.DragoniumIngot;
import mastercrafter.masterores.items.DragoniumPickaxe;
import mastercrafter.masterores.items.DragoniumShovel;
import mastercrafter.masterores.items.DragoniumSword;
import mastercrafter.masterores.items.HardenedStick;
import mastercrafter.masterores.items.PureDiamond;
import mastercrafter.masterores.items.PurePickaxe;
import mastercrafter.masterores.items.Ruby;
import mastercrafter.masterores.items.RubyPickaxe;
import mastercrafter.masterores.items.RubySword;
import mastercrafter.masterores.items.WorldEssence;
import mastercrafter.masterores.items.ZoriumIngot;
import mastercrafter.masterores.items.ZoriumPickaxe;
import mastercrafter.masterores.items.ZoriumSword;
import mastercrafter.masterores.proxies.CommonProxy;
